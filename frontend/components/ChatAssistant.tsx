...
export function ChatAssistant({ code, language }: ChatAssistantProps) {
  ...
  return (
    <div className="glass-card tilt-card card-shine rounded-2xl p-5">
      <div className="flex items-center gap-2 mb-4">
        <div className="w-9 h-9 rounded-xl bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center icon-3d">
